...
if [[ $email =~ "@saungnet.com" ]]; then
echo "Registrasi hanya mendukung saungnet.com"
else
...
<html>
<head>
<title>saungnet</title>
</head>
<body>
<h2>Welcome $name </h1>
Alamat website anda : https://$name.saungnet.com <br />
Login : https://$name.saungnet.com/login.php<br />
Username : admin<br />
Password : $password<br />
Cara ganti password edit pada bagian config.php, cari password anda dan ganti dengan password yang baru<br />
<br />
Login phpmyadmin<br />
Login : https://$name.saungnet.com/phpmyadmin<br />
Username : $name <br />
Password : $password<br />
<br />
Jika file config.php atau login.php terhapus<br />
Login : https://$name.saungnet.com/recovery/login.php<br />
Username : admin <br />
Password : $password<br />
<br />
