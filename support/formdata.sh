...
<html>
<head>
    <title>Pendaftaran SaungNet</title>
     <link rel="stylesheet" href="https://saungnet.com/bootstrap.min.css" integrity="sha384-TX8t27EcRE3e/ihU7zmQxVncDAy5uIKz4rEkgIXeMed4M0jlfIDPvg6uqKI2xXr2" crossorigin="anonymous">
    <style>
    { 
        font: bold 16px;
        color:WHITE;
...
<br>
                ...
                <table class="table">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="name" pattern="^[a-z0-9]+$"  title="Hanya mendukung huruf kecil dan angka.">.saungnet.com
                        </td>
                    </tr>
                    ...
                    <tr>
                       <td>
                        Captcha </td>
                       <td colspan="2"><img src="https://saungnet.com/image.png?$patch">
                       </td>
                        </tr>
                     <tr>
                        <td>Type Captcha : </td>
