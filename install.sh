...
read domain
sed -i "s/saungnet.com/$domain/g" support/subdomain.conf
...
sed -i "s/$domain.pem/saungnet.com.pem/g" support/subdomain.conf
sed -i "s/$domain.key/saungnet.com.key/g" support/subdomain.conf
sudo mkdir /home/saungnet
...
sed -i "s/saungnet.com/$domain/g" support/formdata.sh
sed -i "s/saungnet.com/$domain/g" support/run.sh
sed -i "s/saungnet.com/$domain/g" support/aktivasi3.sh
sed -i "s/saungnet.com.pem/$domain.pem/g" support/subdomain.conf
sed -i "s/saungnet.com.key/$domain.key/g" support/subdomain.conf
sed -i "s/saungnet.com/$domain/g" support/index.html
sed -i "s/-ppasswordmysql/$passwordmysql/g" support/run.sh 
...
echo "Instalasi saungnet tahap awal selesai, silahkan modifikasi isi dan sebagainya, karena sistem hosting ini memanfaatkan API cloudflare."
