...
if [[ $domain =~ "saungnet" ]]; then
echo "Tidak bisa menggunakan subdomain saungnet.com untuk domain"
else
if [[ $domain =~ "saungnet" ]]; then
echo "Tidak bisa menggunakan subdomain saungnet.com untuk domain"
else
...
sudo cp /usr/lib/cgi-bin/image2.png /home/saungnet.com
...
sed -i "s/$name.saungnet.com/$domain/g" /etc/apache2/sites-available/$domain.conf
...
<html>
<head>
<title>saungnet.com</title>
</head>
<body>
<h2>Welcome $name </h1>
<br>
<center>Tahap berikutnya, aktivasi tahap 2, <a href="https://saungnet.com/cgi-bin/tahap2.sh"> klik di sini</a></center>
<br>
<br />
<br>
</body>
